...
DIST_ROOT = LEGACY_ROOT / "dist"
DEFAULT_DB = PROJECT_ROOT / "data" / "trading_ops_ascent.db"
...
class AppHandler(SimpleHTTPRequestHandler):
    ...
    def __init__(self, *args: Any, **kwargs: Any):
        ...
        self._request_id = ""
        root = self.static_root if (self.static_root / "index.html").exists() else PROJECT_ROOT
